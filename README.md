...
| automation\_account\_job\_run\_on | List of names of hybrid worker group the runbook will be executed on. Changing this forces a new resource to be created. | `list(string)` | <pre>[<br>  null<br>]</pre> | no |
...
| automation\_account\_schedule\_expiry\_times | The list of end times of the schedule. | `list(string)` | <pre>[<br>  "9999-12-31T23:59:59Z"<br>]</pre> | no |
